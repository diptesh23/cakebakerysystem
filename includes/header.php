...
?>
                        <!--<a href="tell:+917020663582"><i class="fa fa-phone" aria-hidden="true"></i> + <?php  echo $row['MobileNumber'];?></a>-->
            ...
            <div class="main_menu_area">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <img src="img/mainlogo.png" alt="" class="mainlogo1">
                        <img src="img/mainlogo2.png" alt="" class="mainlogo2">
                        </a>
